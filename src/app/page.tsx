  ...
  const handleSubmit = useCallback(
    async (e: any) => {
      ...
      const conversation: ConversationItem[] = JSON.parse(
        localStorage.getItem(`conversation#${conversation_key}`) ?? '[]',
      );
      ...
      await sendPrompt(
        ...
        },
        {
          onSuccess: () => {
            ...
            localStorage.setItem(`conversation#${conversation_key}`, JSON.stringify(conversation));

...
The format is starting state must be two-dimensional array with 1 and 0 separated by comma in markdown code block, where 0 means dead cell and 1 represents life cell.
